= Bjond Facebook Marketting App

This will serve as the Bjond integration app with the Facebook Marketting API.

For User level documentation, see this page on configuring this adapter with Bjond: https://github.com/Bjond/bjond-health/wiki/Facebook-Ad-Consequences.

We will use the Koala ruby gem to handle interaction with Facebook: 
http://www.rubydoc.info/github/arsduo/koala/master/Koala/Facebook/GraphAPIMethods.

Adapter location:
https://stormy-woodland-11512.herokuapp.com/
...
- Create an RVM gemset. This project currently uses ruby 2.2.2, so the command would be. (ruby version listed in .ruby-version and gemset name listed in .ruby-gemset) - 
    ...
    rvm ruby-2.2.5 
    rvm gemset create bjond-facebook-ad-gems
...
- Environment Variables
    ...
    - BJOND_FACEBOOK_APP_ID (from Facebook App Dashboard)
    - BJOND_FACEBOOK_APP_SECRET (from Facebook App Dashboard)
